...
echo "Installing Tomcat package" | tee ${LOGFILE}
yum -y install tomcat tomcat-webapps tomcat-admin-webapps unzip

echo "Configuring Tomcat" | tee ${LOGFILE}
